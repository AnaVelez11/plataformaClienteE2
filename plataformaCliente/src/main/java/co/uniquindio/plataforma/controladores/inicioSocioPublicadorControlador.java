...
public class inicioSocioPublicadorControlador implements Initializable, CambioIdiomaListener {
    ...
    private void actualizarTextos() {
        titulo.setText(propiedades.getResourceBundle().getString("TextoTitulo"));
        publicador.setText(propiedades.getResourceBundle().getString("TextoPublicador"));
        contenido.setText(propiedades.getResourceBundle().getString("TextoContenido"));
        fecha.setText(propiedades.getResourceBundle().getString("TextoFecha"));
        btnAtras.setText(propiedades.getResourceBundle().getString("TextoAtras"));
        btnXML.setText(propiedades.getResourceBundle().getString("TextoXML"));
